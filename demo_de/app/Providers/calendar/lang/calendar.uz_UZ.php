...
setlocale(LC_ALL, "uz-uz.UTF-8", "uzb-uzb.UTF-8", "uz-Latn-UZ.UTF-8", "uz-Latn-UZ", "uz-uz", "uzb-uzb", "uzbek-uzbek.UTF-8");
} else {
setlocale(LC_ALL, "uz_UZ.UTF-8", "uzb_UZ.UTF-8", "uz.UTF-8", "uzb.UTF-8", "uzb_uzb.UTF-8", "uzbek-uzb.UTF-8");
}
?>