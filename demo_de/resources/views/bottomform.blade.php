...
Date <input name="Date" id="SelectedDate"  onClick="GetDate(this);"   value="{{$info[0]}}"  /> 
Start time&nbsp;<input name="starttime"  id="starttime" value="{{$info[1]}}" class="datebox" >
End Time<input name="endtime" id="endtime" value="{{$info[2]}}" class="datebox" >
 Name <input name="names" id="name" class="namebox" value="{{$info[3]}}">
