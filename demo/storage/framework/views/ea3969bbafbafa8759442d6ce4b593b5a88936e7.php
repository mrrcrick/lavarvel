...
<HTML>
<BODY>
<b> Select Date:  <input style="width:100px;" name="Date" id="maindate" value=""onchange="getdateandconvert('maindate')" onclick="javascript:NewCssCal('maindate','yyyyMMdd','dropdown',true,'12');" ></input></b>
<img src="<?php echo e(URL::asset('js/images2/cal.gif')); ?>" onclick="javascript:NewCssCal('maindate','yyyyMMdd','dropdown',true,'12');" style="cursor:pointer"/>
<span>
...
<div>
<b>STARTTIME: <input id="hour" type="number"style="width:50px;"><b>:</b><input id="minutes" type="number"style="width:50px;"></input> 
<b> ENDTIME: <input id="hour" type="number"style="width:50px;"><b>:</b><input id="minutes" type="number"style="width:50px;"></input>
</div>
