...
function getdateandconvert(datebxid)
	{
		...
		alert(converteddate.getWeek());
		alert(converteddate.getWeekYear())
...
<body>
<div>
<b> Week number: <input id="weeknumber" value="40"> Select Date  <input name="Date" id="maindate" onchange="getdateandconvert('maindate')"></input></b>
