...
function addshift()
{
	...
	+"/"+getTwentyFourHourTime(parent.endtime), "Bottomoptions");  
...
<iframe name="mainpanel" id="mainpanel" src="http://localhost:8000/timetable/40/30/select" height="500" width="800">
</iframe>
