...
<script type="text/javascript" src="{{ URL::asset('js/datetimepicker_css.js') }}"></script>
...
<link href="{{ asset('css/htmlDatePicker.css') }}" rel="stylesheet" type="text/css" >

<script type="text/javascript" src="{{ URL::asset('js/htmlDatePicker.js') }}"></script>
